...
const INSTANT_GIGS: InstantGigDef[] = [
  // ── KopiCraft F&B (6) ──────────────────────────────────────────────────────
  {
    ...
    title: "Barista — Morning Rush Cover",
    description: "Our Toa Payoh barista called in sick. Need an experienced barista to cover 7am–1pm. Full espresso bar, Synesso machine. Bring NSF. Free staff meal included.",
    skills: ["Barista", "Espresso", "F&B", "Customer service"],
    category: "f&b",
    location: "Toa Payoh",
  ...
  },
  {
    ...
    description: "Need an extra pair of hands at our Bishan outlet for a long-weekend promo. Point-of-sale system training takes 15 min. Friendly, fast-moving environment.",
    skills: ["POS system", "Cash handling", "Customer service", "F&B"],
    category: "f&b",
    location: "Bishan",
  ...
  {
    employer_handle: "kopicraft",
    title: "Kitchen Helper — Afternoon Prep",
    description: "Afternoon kitchen prep at our Clementi outlet. Tasks: chopping, portioning, washing. No cooking experience needed — just fast hands and a hygiene cert.",
    skills: ["Kitchen hygiene", "Food preparation", "Teamwork"],
    category: "f&b",
    location: "Clementi",
  ...
  },
  {
    ...
    description: "Deliver bulk orders from our central kitchen to 4 outlets in the west. Must have own car or van. $5 per km fuel supplement. 3-hour window.",
  ...
  {
    employer_handle: "kopicraft",
    title: "Barista — Afternoon Shift",
    description: "Cover 2pm–8pm at our Tampines outlet during a pop-up event. Experienced baristas only — you'll be serving 60+ pax. Specialty coffee menu.",
    skills: ["Barista", "Specialty coffee", "Latte art", "F&B"],
    category: "f&b",
    location: "Tampines",
  ...
  {
    employer_handle: "kopicraft",
    title: "Outlet Supervisor Cover — Weekend",
    description: "Stand-in supervisor for our Boon Lay outlet while our regular is on leave. Handle opening, float, staff scheduling, and inventory count. Weekend shift.",
    skills: ["F&B supervision", "Cash management", "Inventory", "Team leadership"],
    category: "f&b",
    location: "Boon Lay",
  ...
  {
    employer_handle: "sunrise_events",
    title: "Banquet Waitstaff × 3",
    description: "Trained waitstaff needed for a formal dinner at Raffles Place tonight. 3-hour service window. Must have F&B experience and be comfortable in a formal setting.",
    skills: ["Waitstaff", "F&B", "Fine dining", "Customer service"],
    category: "events",
