...
const REGULAR_GIGS = [
  ...
  {
    title: "Recipe developer & food stylist — 10 recipes",
    description: "Develop 10 original recipes featuring our new product line, styled and shot for social media. Kitchen and equipment provided. 4-week project.",
    skills: ["recipe development", "food styling", "food photography", "social media"],
    location: "Kallang",
    category: "f&b",
    budget_cents: 500000,
    budget_kind: "fixed" as const,
  ...
  {
    title: "Halal caterer — weekly office lunch (50 pax)",
    description: "Provide halal catered lunches for our 50-person office every Tuesday and Thursday for 3 months. Delivery + setup at Raffles Place. Variety of SG cuisines.",
    skills: ["catering", "halal", "corporate catering", "food preparation", "delivery"],
    location: "Raffles Place",
    category: "f&b",
    budget_cents: 3500,
    budget_kind: "hourly" as const,
    questions: [
      "Share examples of past weekly corporate catering contracts. Do you have MUIS certification?",
    ],
  },
  {
...
const INSTANT_GIGS = [
  ...
  {
    title: "Urgent: halal catering for board meeting (12 pax) today",
    description: "Deliver a halal lunch set for 12 people to our Raffles Place office by 12:30pm today. 3-course, individually boxed preferred.",
    skills: ["catering", "halal", "corporate catering", "delivery", "same-day"],
    location: "Raffles Place",
    category: "f&b",
    budget_cents: 60000,
    budget_kind: "fixed" as const,
  ...
  {
    title: "Today: barista for pop-up coffee station (4 hours)",
    description: "Operate a pop-up pour-over coffee station at our office event from 2pm–6pm today. Equipment provided. Must have barista experience.",
    skills: ["barista", "coffee", "f&b service", "events", "customer service"],
    location: "Raffles Place",
    category: "f&b",
    budget_cents: 250,
    budget_kind: "hourly" as const,
  ...
  },
  {
    ...
    description: "Write a 150-word WhatsApp broadcast message announcing today's flash sale for our F&B brand. Warm, casual, local tone. Reply with draft within 30 minutes.",
    skills: ["copywriting", "whatsapp", "brand voice", "f&b", "fast turnaround"],
    location: "Remote",
    category: "content",
    budget_cents: 5000,
    budget_kind: "fixed" as const,
